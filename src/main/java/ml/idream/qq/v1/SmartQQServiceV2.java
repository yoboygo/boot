 ...
 **/
public class SmartQQServiceV2 extends Thread {

    private static final Logger logger = LoggerFactory.getLogger(SmartQQServiceV2.class);
    //请求的上下文环境
...
//        this.cookieStore = new BasicCookieStore();
        ...
        this.globleClient = HttpClients.custom()
    ...
    public void getEwm() throws IOException {
        ...
        getGlobleClient().execute(method, new ImageResponseHander("d:\\QRCode"),context);
//        client.execute(method);
    ...
    public static void main(String[] args) throws IOException {
        ...
        String path = SmartQQServiceV2.class.getClassLoader().getResource("").getPath();
        PropertyConfigurator.configure(path + "/log4j2.yml");

        SmartQQServiceV2 qqLogin = new SmartQQServiceV2();
        qqLogin.start();
